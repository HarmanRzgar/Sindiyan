...
const solutions = [
  {
    ...
    painPoint:
      "Finding consistently high-quality wood products in today's market can be challenging and overwhelming.",
    agitatepainPoint:
      "It's frustrating when wood products don't meet your expectations, showing inconsistencies in quality and finish that affect your project's outcome.",
    solution:
      "Our rigorous quality control and expert selection process ensures every piece meets the highest standards. Each product undergoes thorough inspection before delivery.",
    img: visibilityDilemma,
  },
  {
    title: "Custom Creation",
    painPoint:
      "Standard wood products often don't fit your specific needs or match your unique vision.",
    agitatepainPoint:
      "It's disappointing when you can't find exactly what you're looking for, forcing you to compromise on your design or functionality requirements.",
    solution:
      "Our custom woodworking service brings your vision to life, crafting pieces that perfectly match your specifications and exceed your expectations.",
    img: engagementGap,
  },
  {
    title: "Expert Craftsmanship",
    painPoint:
      "Mass-produced wood products often lack the attention to detail and durability that comes with true craftsmanship.",
    agitatepainPoint:
      "Poor quality workmanship leads to premature wear and disappointing results, wasting both time and money on replacements.",
    solution:
      "Our master craftsmen combine traditional techniques with modern precision, creating lasting pieces that showcase the natural beauty of wood.",
